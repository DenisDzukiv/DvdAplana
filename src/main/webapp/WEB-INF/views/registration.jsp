    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin">
        ...
        <spring:bind path="userfirstname">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="userfirstname" class="form-control" placeholder="Userfirstname"
        ...
        <spring:bind path="userlastname">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="userlastname" class="form-control" placeholder="Userlastname"
                            autofocus="true"></form:input>
        ...
        <spring:bind path="usersurname">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="usersurname" class="form-control" placeholder="Usersurname"
                            autofocus="true"></form:input>
